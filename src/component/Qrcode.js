              ...
              <CardContent>
                  <Grid container spacing={2}>
                      <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
                          {/*<TextField label="Name" onChange={(e) => setText(e.target.value)}/>*/}
                      ...
                      <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
                        ...
                        <Button className={classes.btn} variant="contained" color="secondary" onClick={onScanFile}>Scan For Qr Code</Button>
                        <QrReader
                          ref={qrRef}
                          delay={300}
                          style={{width: '100%'}}
